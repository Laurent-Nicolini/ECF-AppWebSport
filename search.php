    ...
    <main>
        ...
        <div class="container d-flex justify-content-around flex-wrap">
            ...
            if (!empty($result)){
                foreach ($result as $results) {
                    ...
                    <div class='card mx-3 my-3' style='width: 18rem;'>
                        ...
                        <div class='card-body'>
                            ...
                            <p class='card-text'>ID Client: <?= $partenaire ?></p>
                ...
                <?php }} else { echo "<div class='bg-warning text-center'>Il n'y a pas de résultat pour cette recherche !</div>";}?>
    </main>
